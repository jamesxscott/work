...
public class DarwinHPS {
	...
	public static void hpspost() throws ClientProtocolException, IOException, AuthenticationException {
		...
		comment.put("from_loc","BTN");
		comment.put("to_loc","VIC");
		comment.put("from_time","0800");
		comment.put("to_time","1000");
		comment.put("from_date","2017-12-28");
		comment.put("to_date","2017-12-29");
		...
		try {
			...
			String json_string = EntityUtils.toString(response2.getEntity());
